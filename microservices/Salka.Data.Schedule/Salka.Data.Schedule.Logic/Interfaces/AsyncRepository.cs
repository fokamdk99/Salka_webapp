...
namespace Salka.Data.Schedules.Logic.Interfaces
{
    public class AsyncRepository<T> : IAsyncRepository<T> where T : BaseEntity
    {
        protected readonly salkadbscheduleContext _dbContext;

        public AsyncRepository(salkadbscheduleContext dbContext)
        {
